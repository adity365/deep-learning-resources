...
# Line2D is a class we are using from the matplotlib library used to define how a line in a plot should look like 
from matplotlib.lines import Line2D

from matplotlib.colors import Normalize
# This imports the Normalization class from matplotlib, scales data into a fixed range, usually 0 to 1, so it can be mapped to colors 
...
def plot_delivery_data(df):
    ...
    # plt = matplotlib plotting library , style.use() = apply a ready-made visual theme
    #'seaborn-v0_8-whitegrid' = a style that: 1.looks like Seaborn plots 2.has white background
    #3. has grid lines
